...
if($time_range=="all"){
	...
	$cpuUsage[0] = array("Date-time", "Usage in MHz");
	$memoryUsage[0] = array("Date-time", "Memory in MB");
	$diskUsage[0] = array("Date-time", "Usage in KBps");
	$networkUsage[0] = array("Date-time", "Usage in Mbps");
